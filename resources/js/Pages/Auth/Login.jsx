        ...
        <div className="container mx-auto md:px-10 px-0">
            <div >
                <div className="bg-white shadow rounded mb-6">
                    <div className="grid md:grid-cols-12">
                        <div className="bg-white shadow-md p-12 rounded-s xl:col-span-5 md:col-span-6">
                            <div className="mb-12">
                                <a href="index.html">
                                    <img src="assets/images/logo-dark.png" alt="logo-img" className="h-8" />
                                </a>
                            </div>
                            <h6 className="text-base/[1.6] font-semibold text-gray-600 mb-0 mt-4">Welcome back!</h6>
                            <p className="text-gray-500 text-sm/[1.6] mt-1 mb-6">Enter your email address and password to access admin panel.</p>
                ...
                <div className="flex items-center justify-end mt-4">
                    ...
                    <PrimaryButton className="ms-4" disabled={processing}>
                        Log in
                            ...
                            <div className="py-4 text-center"><span className="fs-13 fw-bold">OR</span></div>

                            <div className="w-full">
                                <a href="" className="block border text-gray-500 font-medium leading-6 text-center align-middle select-none py-2 px-4 text-sm rounded-md transition-all hover:shadow-md">
                                    <span className="flex items-center justify-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="feather feather-github icon icon-xs me-2">
                ...
                <div className="w-full text-center">
                    <p className="text-gray-500 leading-6 text-base">Don't have an account? <a href="account-signup.html" className="text-primary font-semibold ms-1">Sign Up</a></p>
                </div>
            </div>
        </div>
    </div>
