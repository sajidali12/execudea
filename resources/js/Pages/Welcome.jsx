                    ...
                    <div className="container">
                        <div className="text-center mb-16 md:px-10 px-0">
                            ...
                            <p className="font-medium text-slate-500 mb-8">
                                We're a team of lifelong learners. We're equal
                                parts left and right brained.
                            </p>
                            <a
                                href="#"
                                className="py-3 px-6 rounded border border-primary font-medium text-white bg-primary hover:shadow-lg hover:shadow-black/50 focus:outline focus:outline-black/50 transition-all duration-500"
                            >
