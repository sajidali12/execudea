...
export default function Services() {
    return (
        <>
            <Head title="Best web development company in pakistan" />
            <Guest>
                        ...
                        <div class="grid lg:grid-cols-7 grid-cols-1 gap-16 items-center">
                            ...
                            <div class="lg:col-span-3" data-aos="fade-left">
                                <div class="text-center sm:text-start">
                                    <h1 class="text-3xl/snug sm:text-4xl/snug xl:text-5xl/snug font-semibold font-futura-bold mb-7">Build Your <span class="relative after:bg-red-500/50 after:-z-10 after:absolute after:h-6 after:w-full after:bottom-0 after:end-0">Websites</span> with Execudea.
                                    </h1>
                                    <p class="text-base/relaxed text-gray-500"> At Execudea, we specialize in web development, seamlessly integrating both front-end and back-end technologies to create robust, visually appealing, and highly interactive websites and applications. 
                                    Our skilled team transforms design mockups into functional code using cutting-edge front-end technologies like <b>React.js and Vue.js</b>, alongside <b>HTML, CSS, and JavaScript</b>. 
                                    On the back end, we leverage <b>Next.js, Laravel, Node.js</b>, and <b>PHP</b> to ensure performance and optimization, delivering applications that load quickly and provide exceptional user experiences across all devices.</p>
                ...
                <div className="container md:px-10 px-4 m-auto mt-10">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mx-4 mt-14">
                        {[
                            { title: "Front-End Development", description: "We use HTML, CSS, Tailwind, Bootstrap, JavaScript, React.js, Vue.js, Angular.js, and more to make your site look attractive and fast." },
                            ...
                            { title: "Cloud Services", description: "We use various cloud services like AWS, Azure, GCP, DigitalOcean, and more to utilize your traffic and deploy your site live." },
                            { title: "API Development and Integration", description: "We create custom APIs and integrate third-party APIs to connect across various platforms." },
