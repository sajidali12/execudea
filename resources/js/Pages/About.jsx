...
export default function About() {
    return (
        <>
            ...
            <Guest>
                <section class="pt-36 pb-24 relative">
                ...
                <section class="lg:py-24 py-16">
                    <div class="container m-auto md:px-10 px-4" data-aos="fade-up">
                        <div class="grid lg:grid-cols-3 grid-cols-1 gap-10">
                            ...
                            <div>
                                <p class="text-sm/relaxed tracking-wider text-gray-600">
        ...
        <div class="container m-auto md:px-10 px-4" data-aos="fade-up">
            <div class="md:grid lg:grid-cols-2 gap-14 block md:text-left text-center">
                ...
                <div class="order-2 lg:order-1">
                    <h2 class="text-3xl mb-7">What We Offer</h2>
                    ...
                    <div class="flex items-center">
                        <a href="/contact" className="bg-primary text-white px-4 py-2 rounded inline-flex items-center text-sm">Contact Us <i class="fa-solid fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
