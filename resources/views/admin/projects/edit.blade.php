        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Update project details for {{ $project->name }}</p>
                </div>
            ...
            <div class="mb-8">
                ...
                <div class="mt-6">
                    ...
                    <textarea id="description" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary @error('description') border-red-500 @enderror">{{ old('description', $project->description) }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="mb-8">
                ...
                <div>
                    <textarea id="notes" 
                              ...
                              class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary focus:border-primary @error('notes') border-red-500 @enderror">{{ old('notes', $project->notes) }}</textarea>
                    @error('notes')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    @if($project->project_image)
                        <div class="md:col-span-2 mb-4">
                            <label class="block text-sm font-medium text-gray-700 mb-2">Current Project Image</label>
                    ...
                    <div class="md:col-span-2">
                        <label for="project_image" class="block text-sm font-medium text-gray-700 mb-2">
                            {{ $project->project_image ? 'Replace Project Image' : 'Project Image' }}
                        </label>
                        <input type="file" 
                               id="project_image" 
                               name="project_image" 
                    ...
                    <div class="md:col-span-2">
                        <div class="flex items-center">
                            ...
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   {{ old('show_on_website', $project->show_on_website) ? 'checked' : '' }}
