...
<div class="max-w-4xl mx-auto">
    <div class="bg-white shadow rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            ...
            <p class="text-sm text-gray-600 mt-1">Update course information</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="file" 
                               ...
                               name="image" 
                               accept="image/*">
                        <p class="text-xs text-gray-500 mt-1">Upload a new image to replace current one (JPG, PNG, GIF, SVG - Max: 2MB)</p>
                        @error('image')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
