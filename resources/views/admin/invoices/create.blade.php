        ...
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Generate an invoice for a client</p>
                </div>
        ...
        <form action="{{ route('admin.invoices.store') }}" method="POST" class="p-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <select id="client_id" 
                            ...
                            @foreach($clients as $client)
                                <option value="{{ $client->id }}" {{ (old('client_id', $selectedProject?->client_id) == $client->id) ? 'selected' : '' }}>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <input type="checkbox" 
                                   ...
                                   {{ old('subscription_based') ? 'checked' : '' }}
            ...
            <div class="mb-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="next_due_date_field" style="display: none;">
                        ...
                        <input type="date" 
                               id="next_due_date" 
                               name="next_due_date" 
                               value="{{ old('next_due_date', date('Y-m-d', strtotime('+1 year'))) }}"
...
function loadClientProjects(clientId) {
    ...
    if (clientId) {
        ...
        // If no client selected, hide all projects and reset selection
        for (let i = 1; i < options.length; i++) {
            options[i].style.display = 'none';
            options[i].selected = false;
        }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle pre-selected project from project page
    @if($selectedProject)
        loadClientProjects('{{ $selectedProject->client_id }}');
    @endif
});
</script>
@endpush
