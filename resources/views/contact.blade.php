                        ...
                        <form action="{{ route('contact.store') }}" method="POST">
                            ...
                            <div class="w-full">
                                <div class="mb-5">
                                    ...
                                    <input
                                        type="text"
                                        class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0 @error('subject') border-red-500 @enderror"
                                        id="subject"
                                        name="subject"
                            ...
                            <div class="w-full">
                                <div class="mb-5">
                                    ...
                                    <textarea
                                        class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0 @error('message') border-red-500 @enderror"
                                        id="message"
                                        name="message"
                                        rows="4"
        ...
        <div class="grid md:grid-cols-3 gap-6">
            <div class="flex mb-3">
                ...
                <div class="grow">
                    ...
                    <a href="mailto:info@execudea.com" class="text-gray-500 my-1">
                        info@execudea.com
                    </a>
                </div>
            </div>
            ...
            <div class="flex mb-3">
                ...
                <div class="grow">
                    ...
                    <a href="tel:+923365707907" class="text-gray-500 my-1">
                        +92 336 5707907
                    </a>
                </div>
            </div>
